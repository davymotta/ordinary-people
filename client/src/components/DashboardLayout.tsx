      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-2">
            <h1 className="text-4xl font-extrabold tracking-[-0.04em] text-foreground">
              Ordinary People
            </h1>
          ...
          <Button
            ...
            size="lg"
            className="w-full bg-primary text-primary-foreground hover:opacity-90 transition-opacity font-semibold"
          >
            Sign in
          </Button>
        </div>
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  <span className="font-extrabold tracking-[-0.04em] text-sm truncate">
                    Ordinary People
                  </span>
                </div>
              ) : null}
